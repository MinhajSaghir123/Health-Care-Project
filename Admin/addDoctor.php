                ...
                <div class="col-sm-12">
                    ...
                    <form action="addDoctor.php" method="POST" enctype="multipart/form-data">
                        ...
                        <select class="text-dark form-control" 
                            name="addDoc_specialist" required style="width:100%;" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1"
                                name="addDoc_Qualification" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            name="addDoc_time" required>
                            To
                            <input type="time" class="form-control" id="exampleInputPassword1"
                            name="addDoc_endtime" required>
                        </div>
